...
public class TransaccionController {
    ...
    @PostMapping
    public ResponseEntity<?> crearTransaccion(@Valid @RequestBody TransaccionRequest request, Authentication authentication) {
        try {
            ...
            Map<String, String> error = new HashMap<>();
            error.put("error", "Error interno al procesar la transacción");
            error.put("mensaje", e.getMessage());
